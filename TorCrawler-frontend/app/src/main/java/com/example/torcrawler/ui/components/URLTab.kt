...
fun URLTab(
    ...
    Column(
        ...
        Column(
            ...
            val image: Painter = painterResource(id = R.drawable.ic_globe)
            Image(
                painter = image,
            ...
            OutlinedTextField(
                ...
                placeholder = { Text(text = "Enter an Onion URL",color = MaterialTheme.colorScheme.onSurface.copy(alpha = 0.6f)) },
